    ...
    if(_emailController.text.isEmpty || _emailController.text.isEmpty)  {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          ...
          content: Text('Enter Email and Password'.toUpperCase(),textAlign: TextAlign.center,style: TextStyle(color: Colors.white)),
        ),
      );
    }
      ...
      if (context.mounted) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            ...
            content: Text('Login successfully'.toUpperCase(),style: TextStyle(color: Colors.white)),
          ),
        );
      }
    }
       ...
       // showSnackBar(context, res);
        if(_emailController.text.isNotEmpty || _emailController.text.isNotEmpty){
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(
              backgroundColor: Colors.red,
              content: Text('Invalid Email And Password'.toUpperCase(),textAlign: TextAlign.center,style: TextStyle(color: Colors.white)),
            ),
          );
        }
